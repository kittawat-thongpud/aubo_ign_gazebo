...
def generate_launch_description():
    package_name = "aubo_i5"
    package_path = Path(get_package_share_directory(package_name))
    moveit_config = (
                    MoveItConfigsBuilder("aubo_i5", package_name=package_name,robot_description="robot_description")
                    .robot_description(file_path="config/aubo_i5.urdf.xacro", mappings={"use_sim_model":"false",})
    ...
    spawn_controller = ExecuteProcess(
        cmd=['ros2', 'launch', package_name, 'spawn_controllers'],
        output='screen'
    )
    ...
    '''
    try:
        with open("/home/kittawat/ros2_ws/src/aubo_ign_gazebo/aubo_i5/save.json", 'w') as file:
