...
def generate_launch_description():
    package_name = "aubo_i10_depth"
    package_path = Path(get_package_share_directory(package_name))
    moveit_config = (
                    MoveItConfigsBuilder("aubo_i10_depth", package_name=package_name,robot_description="robot_description")
                    .robot_description(file_path="config/aubo_i10_depth_camera.urdf.xacro")
                    .robot_description_semantic(file_path="config/aubo_i10_depth_camera.srdf")
    ...
    gz_spawn_entity = Node(
        ...
        arguments=['-topic', 'robot_description', '-name',
                   'aubo_i10_depth', '-allow_renaming', 'true'],
    )
    ...
    rgb_camera_bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        arguments=['/rgb_camera@sensor_msgs/msg/Image[ignition.msgs.Image'],
        output='screen'
    )
    ...
    '''
    try:
        with open("/home/kittawat/ros2_ws/src/aubo_ign_gazebo/aubo_i10_depth/save.json", 'w') as file:
